...
The runner writes a reusable runtime profile, then uses `wikiskill experiment run`
to prepare, evolve, and audit in one command. It preserves the emitted experiment artifact and full run under
